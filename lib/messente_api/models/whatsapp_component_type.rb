...
module MessenteApi
  class WhatsappComponentType
    ...
    def self.all_vars
      @all_vars ||= [BODY, HEADER, FOOTER, BUTTONS].freeze
    end
    ...
    def build_from_hash(value)
      return value if WhatsappComponentType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #WhatsappComponentType"
    end
  end
end
