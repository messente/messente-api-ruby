  ...
  class RcsStandaloneCard
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MessenteApi::RcsStandaloneCard` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MessenteApi::RcsStandaloneCard`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'card_orientation')
        self.card_orientation = attributes[:'card_orientation']
      else
        self.card_orientation = nil
      end
    ...
    def list_invalid_properties
      ...
      if @card_orientation.nil?
        invalid_properties.push('invalid value for "card_orientation", card_orientation cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @card_orientation.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          card_orientation == o.card_orientation &&
    ...
    def hash
      [card_orientation, thumbnail_image_alignment, card_content].hash
    end
