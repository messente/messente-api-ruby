...
module MessenteApi
  class BlacklistApi
    ...
    def add_to_blacklist_with_http_info(number_to_blacklist, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(number_to_blacklist)
    ...
    # Returns all blacklisted phone numbers.
    # @param [Hash] opts the optional parameters
    # @return [Array<(FetchBlacklistSuccess, Fixnum, Hash)>] FetchBlacklistSuccess data, response status code and response headers
    def fetch_blacklist_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'FetchBlacklistSuccess')
      if @api_client.config.debugging
