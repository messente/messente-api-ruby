...
module MessenteApi
  class ContactsApi
    ...
    # @param contact_fields 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ContactEnvelope, Fixnum, Hash)>] ContactEnvelope data, response status code and response headers
    def create_contact_with_http_info(contact_fields, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(contact_fields)
      auth_names = ['basicAuth']
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        :header_params => header_params,
        :query_params => query_params,
    ...
    def fetch_contacts_with_http_info(opts = {})
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ContactListEnvelope')
      if @api_client.config.debugging
    ...
    def update_contact_with_http_info(phone, contact_update_fields, opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(contact_update_fields)
      auth_names = ['basicAuth']
